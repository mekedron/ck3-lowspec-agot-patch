...
В AGOT частоту кадров дают настройки — «низкое» качество текстур на карте с 4 ГБ,
объекты на карте выключены, — а в королевском дворе
[AGOT Vanilla Courts](https://github.com/mekedron/ck3-agot-vanilla-courts). Урезанный туман
войны AGOT (снятый AGOT Performance Patch) заметной разницы не дал.
